...
public class CatalogoDisciplinas {
	...
	public CatalogoDisciplinas() {
		...
		todasDisciplinas.add(new Disciplina("Leitura e Produção de Textos", 4, 1));
		...
		todasDisciplinas
				.add(new Disciplina(
						"Programação II",
						4,
						listaDePreRequisitos("Programação I, Lab. de Programação I, Introdução a Computação"), 1));
		todasDisciplinas.add(new Disciplina("Teoria dos Grafos", 2,
				listaDePreRequisitos("Programação I, Lab. de Programação I"), 2));
		todasDisciplinas
				.add(new Disciplina(
						"Fund. de Física Clássica",
						4,
						listaDePreRequisitos("Cálculo I, Álgebra Vetorial e Geometria Analítica"), 2));
		todasDisciplinas
				.add(new Disciplina(
		...
		todasDisciplinas
				.add(new Disciplina(
						"Álgebra Linear",
						4,
						listaDePreRequisitos("Álgebra Vetorial e Geometria Analítica"), 3));
		...
		todasDisciplinas
				.add(new Disciplina(
						...
						4,
						listaDePreRequisitos("Teoria dos Grafos, Introdução a Computação, Matemática Discreta"), 3));
		todasDisciplinas
				.add(new Disciplina(
						"Estruturas de Dados e Algoritmos",
						4,
						listaDePreRequisitos("Teoria dos Grafos, Programação II, Lab. de Programação II"), 2));
		todasDisciplinas.add(new Disciplina("Fund. de Física Moderna", 4,
				listaDePreRequisitos("Cálculo II, Fund. de Física Clássica"), 3));
		...
		todasDisciplinas
				.add(new Disciplina(
						...
						4,
						listaDePreRequisitos("Álgebra Linear, Probabilidade e Estatística"), 2));
		todasDisciplinas
				.add(new Disciplina(
						"Paradigmas de Linguagem de Programação",
						2,
						listaDePreRequisitos("Teoria da Computação, Estruturas de Dados e Algoritmos, Lab. de Estruturas de Dados e Algoritmos"), 2));
		...
		todasDisciplinas
				.add(new Disciplina(
						...
						4,
						listaDePreRequisitos("Estruturas de Dados e Algoritmos, Lab. de Estruturas de Dados e Algoritmos, Fund. de Física Moderna"), 3));
		todasDisciplinas
				.add(new Disciplina(
		...
		todasDisciplinas
				.add(new Disciplina(
						...
						4,
						listaDePreRequisitos("Programação II, Lab. de Programação II, Probabilidade e Estatística"), 3));
		...
		todasDisciplinas
				.add(new Disciplina(
						...
						4,
						listaDePreRequisitos("Estruturas de Dados e Algoritmos, Lab. de Estruturas de Dados e Algoritmos, Cálculo II, Lógica Matemática"), 3));
		todasDisciplinas
				.add(new Disciplina(
						"Compiladores",
						4,
						listaDePreRequisitos("Paradigmas de Linguagem de Programação, Organização e Arquitetura de Computadores I, Lab. de Organização e Arquitetura de Computadores I"), 3));
		todasDisciplinas
				.add(new Disciplina(
						"Redes de Computadores",
						4,
						listaDePreRequisitos("Organização e Arquitetura de Computadores I, Lab. de Organização e Arquitetura de Computadores I"), 2));
		...
		todasDisciplinas
				.add(new Disciplina(
						...
						4,
						listaDePreRequisitos("Organização e Arquitetura de Computadores I, Lab. de Organização e Arquitetura de Computadores I"), 3));
		todasDisciplinas.add(new Disciplina(
		...
		todasDisciplinas
				.add(new Disciplina(
						...
						4,
						listaDePreRequisitos("Analises e Tecnicas de Algoritmos, Paradigmas de Linguagem de Programação, Métodos Estatísticos"), 3));
		todasDisciplinas
				.add(new Disciplina(
						"Banco de Dados II",
						4,
						listaDePreRequisitos("Banco de Dados I, Sistemas de Informação II"), 3));
		...
		todasDisciplinas
				.add(new Disciplina(
						...
						4,
						listaDePreRequisitos("Álgebra Linear, Analises e Tecnicas de Algoritmos"), 3));
		todasDisciplinas.add(new Disciplina(
		...
		todasDisciplinas
				.add(new Disciplina(
						...
						4,
						listaDePreRequisitos("Lab. de Engenharia de Software, Metodologia Científica"), 3));
